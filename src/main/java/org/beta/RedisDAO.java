...
public class RedisDAO extends AbstractMagicDAO {
	...
	public static void main(String[] args) {
			...
			var conf = RedisURI.Builder.redis("localhost", 49154)
													.withPassword("mtgcompanionpwd".toCharArray())
													.withClientName("default")
													.withDatabase(1)
													.build();
			
			var redisClient = RedisClient.create(conf);
			...
			var record = syncCommands.hgetall("recordName");
