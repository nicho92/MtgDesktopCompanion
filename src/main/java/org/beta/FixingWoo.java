...
public class FixingWoo {
	...
	public static void main(String[] args) throws SQLException, IOException {
		...
		for(var mcs : MTG.getEnabledPlugin(MTGDao.class).listStocks().stream().filter(mcs->mcs.getId()<651 && mcs.getTiersAppIds(WooCommerceTools.WOO_COMMERCE_NAME)==null).toList())
		{
