...
public class ActiveMQConsoleServer extends AbstractWarServer {
	...
	protected String warUri() {
		return "https://repo1.maven.org/maven2/org/apache/artemis/artemis-console/" + getVersion() + "/artemis-console-"
				+ getVersion() + ".war";
	}
	...
	public Icon getIcon() {
		try {
			return new ImageIcon(new ImageIcon(AbstractMTGPlugin.class.getResource("/icons/plugins/activemq.png"))
					.getImage()
