...
public class SealedStockTableModel extends GenericTableModel<MTGSealedStock> {
	...
	public Object getValueAt(int row, int column) {
		...
		switch (column) {
			case 0 :
				return it;
			case 1 :
				return it.getProduct().getTypeProduct();
			case 2 :
				return it.getProduct().getExtra();
			case 3 :
				return it.getProduct().getEdition();
			case 4 :
			...
			case 6 :
				return it.getQte();
			case 7 :
				return it.getMagicCollection();
			case 8 :
				return it.getValue();
			case 9 :
				return it.getTiersAppIds();
			default :
	...
	public void setValueAt(Object aValue, int row, int column) {
		...
		switch (column) {
			case 4 :
				it.setLanguage(String.valueOf(aValue));
				break;
			case 5 :
				it.setCondition((EnumCondition) aValue);
				break;
			case 6 :
				it.setQte(Integer.parseInt(String.valueOf(aValue)));
				break;
			case 7 :
				it.setMagicCollection(new MTGCollection(String.valueOf(aValue)));
				break;
			case 8 :
				it.setPrice(UITools.parseDouble(aValue.toString()));
				break;
			default :
				break;
		}
