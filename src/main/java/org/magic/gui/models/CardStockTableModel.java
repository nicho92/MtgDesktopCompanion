...
public class CardStockTableModel extends GenericTableModel<MTGCardStock> {
	...
	public CardStockTableModel() {
		setWritable(true);
		setColumns("ID", "NUMBER", "CARD", "EDITION", "RARITY", "COLLECTION", "QUALITY", "QTY", "CARD_LANGUAGE", "FOIL",
				"ETCHED", "SIGNED", "ALTERED", "DIGITAL", "PRICE", "GRADED", "COMMENTS", "SYNC", "Update");
	}

	@Override
	public int[] defaultHiddenColumns() {
		return new int[]{1, 4, 10, 11, 12, 15, 18};
	}
