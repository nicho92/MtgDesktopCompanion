...
public class MkmOversightDashlet extends AbstractJDashlet {
	...
	private enum INSIGHT_SELECTION {
		STOCK_REDUCTION, BEST_BARGAIN, TOP_CARDS, BIGGEST_START_PRICE, BIGGEST_START_PRICE_FOIL, BIGGEST_AVG_SALES, BIGGEST_AVG_SALES_FOIL
	}
	...
	public void initGUI() {
		...
		UITools.initCardToolTipTable(table, 0, null, null, new Callable<Void>() {
			...
			public Void call() throws Exception {
				...
				UITools.browse(MkmConstants.MKM_SITE_URL + "/en/Magic/Products/Singles/" + URLTools.encode(setName)
						+ "/" + URLTools.encode(cardName));
