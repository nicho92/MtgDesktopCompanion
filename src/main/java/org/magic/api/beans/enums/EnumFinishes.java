...
public enum EnumFinishes implements MTGEnumeration {
	...
	@SerializedName(alternate = "etched", value = "ETCHED")
	ETCHED, @SerializedName(alternate = "foil", value = "FOIL")
	FOIL, @SerializedName(alternate = "glossy", value = "GLOSSY")
	GLOSSY, @SerializedName(alternate = "nonfoil", value = "NONFOIL")
	NONFOIL, @SerializedName(alternate = "signed", value = "SIGNED")
	SIGNED;
