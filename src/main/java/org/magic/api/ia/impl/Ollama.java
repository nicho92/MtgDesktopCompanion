...
public class Ollama extends AbstractIA{
	...
	public Map<String, MTGProperty> getDefaultAttributes() {
		var m =  super.getDefaultAttributes();
			 ...
			 m.put("TEMPERATURE", MTGProperty.newIntegerProperty("0.7", "You can think of temperature like randomness, with low value is being least random (or most deterministic) and max being most random (least deterministic)", 0, 1));
		return m;
	}
