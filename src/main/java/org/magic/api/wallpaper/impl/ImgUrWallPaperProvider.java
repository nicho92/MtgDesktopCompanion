...
public class ImgUrWallPaperProvider extends AbstractWallpaperProvider {
	...
	public List<MTGWallpaper> search(String search) {
		...
		try {
			...
			String s = c.toString(c.doGet("https://api.imgur.com/3/gallery/search/" + getString("SORT").toLowerCase()
					+ "/" + getString("WINDOW"), h, e));
	...
	public Map<String, MTGProperty> getDefaultAttributes() {
		return Map.of("SORT", new MTGProperty("time", "The default sorter of the results", "time", "viral", "top"),
				"WINDOW",
				new MTGProperty("all", "Change the date range of the request if the sort is top", "day", " week",
						"month", "year", "all"),
