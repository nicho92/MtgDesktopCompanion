...
public class SlightlyMagicPictureProvider extends AbstractPicturesProvider {
	...
	public String generateUrl(MTGCard mc) {
		...
		int size = FileTools.listFiles(edDir, WildcardFileFilter.builder().setWildcards(mc.getName() + "*").get(),
	...
	public Map<String, MTGProperty> getDefaultAttributes() {
		return Map.of(PICS_DIR,
				MTGProperty.newDirectoryProperty(Paths.get(MTGConstants.DATA_DIR.getAbsolutePath(), "forge")));
	}
