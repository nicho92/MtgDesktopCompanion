...
public class SQLCriteriaBuilder implements MTGQueryBuilder<Query>
{
			...
			for(MTGCrit<?> c:crits)
			{
				...
				else
				{
					...
					switch(c.getOperator())
					{
						...
						case IN: ((SelectWhereStep<Record3<Object, Object, Object>>) query).where(field(c.getAtt()).in(c.getVal()));break;
					}
				}
			}
