		...
		for (MTGCrit<?> c : crits) {
			if (c.isList()) {
				...
				switch (c.getOperator()) {
					case EQ :
						((SelectWhereStep<Record3<Object, Object, Object>>) query)
								.where(field(c.getAtt()).eq(getValueFor(c.getFirst())));
						break;
					case GREATER :
						((SelectWhereStep<Record3<Object, Object, Object>>) query)
								.where(field(c.getAtt()).greaterThan(getValueFor(c.getFirst())));
						break;
					case LOWER :
						((SelectWhereStep<Record3<Object, Object, Object>>) query)
								.where(field(c.getAtt()).lessThan(getValueFor(c.getFirst())));
						break;
					case LIKE :
						((SelectWhereStep<Record3<Object, Object, Object>>) query)
								.where(field(c.getAtt()).like("%" + getValueFor(c.getFirst()) + "%"));
						break;
					case END_WITH :
						((SelectWhereStep<Record3<Object, Object, Object>>) query)
								.where(field(c.getAtt()).like("%" + getValueFor(c.getFirst())));
					...
					case GREATER_EQ :
						((SelectWhereStep<Record3<Object, Object, Object>>) query)
								.where(field(c.getAtt()).greaterOrEqual(getValueFor(c.getFirst())));
						break;
					case LOWER_EQ :
						((SelectWhereStep<Record3<Object, Object, Object>>) query)
								.where(field(c.getAtt()).lessOrEqual(getValueFor(c.getFirst())));
						break;
					case IN :
						((SelectWhereStep<Record3<Object, Object, Object>>) query)
								.where(field(c.getAtt()).in(getValueFor(c.getVal())));
					...
					case NOT :
						((SelectWhereStep<Record3<Object, Object, Object>>) query)
								.where(field(c.getAtt()).notEqual(getValueFor(c.getVal())));
						break;
				}
			}
		}
