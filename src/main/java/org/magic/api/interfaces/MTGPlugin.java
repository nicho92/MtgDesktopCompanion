...
public interface MTGPlugin extends Comparable<MTGPlugin>, MTGIconable {
	...
	public enum PLUGINS {
		PROVIDER, DASHBOARD, PRICER, SERVER, EXPORT, DECKSNIFFER, DAO, TOKEN, CACHE, NEWS, WALLPAPER, NOTIFIER,DASHLET,EDITOR, INDEXER,GENERATOR, SCRIPT, POOL,COMBO, GRADING, GED, STRATEGY, PICTURE, SHOPPER, TRACKING, EXTERNAL_SHOP, IA, SEALED, NETWORK;
	}
