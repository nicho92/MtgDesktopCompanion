...
public interface MTGPlugin extends Comparable<MTGPlugin> {
	...
	public enum PLUGINS {
		PROVIDER, DASHBOARD, PRICER, SERVER, HOPPER, EXPORT, DECKSNIFFER, DAO, TOKEN, CACHE, NEWS, WALLPAPER, NOTIFIER,DASHLET,COMMAND,EDITOR, INDEXER,GENERATOR, SCRIPT, POOL,COMBO, GRADING, GED, STRATEGY, PICTURE, SHOPPER, TRACKING, EXTERNAL_SHOP, IA, SEALED;
	}
