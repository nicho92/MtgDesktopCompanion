...
public abstract class AbstractWebServer extends AbstractMTGServer {
	...
	public ServerConnector createHttpsConnector(HttpConfiguration httpConfig) {
		...
		var https = new ServerConnector(server,
	...
	public void start() throws IOException {
		try {
			...
			logger.info("Server {} ({}) start on port {} @ {}", getName(), getVersion(), getInt(SERVER_PORT),
					webRootLocation);
		} catch (Exception e) {
			logger.error(e);
	...
	public Map<String, MTGProperty> getDefaultAttributes() {
		...
		m.put(KEYSTORE_URI, MTGProperty.newFileProperty(new File(MTGConstants.DATA_DIR, "jetty.jks"),
				"location of certificates keystore file"));
