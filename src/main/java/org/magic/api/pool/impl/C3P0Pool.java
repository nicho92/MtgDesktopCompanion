...
public class C3P0Pool extends AbstractPoolProvider {
	...
	public Map<String, MTGProperty> getDefaultAttributes() {
		...
		map.put("maxConnectionAge", MTGProperty.newIntegerProperty("0",
				...
				0, -1));
		map.put("idleConnectionTestPeriod", MTGProperty.newIntegerProperty("0",
				"If this is a number greater than 0, c3p0 will test all idle, pooled but unchecked-out connections, every this number of seconds",
				0, -1));
		map.put("initialPoolSize", MTGProperty.newIntegerProperty("3",
				"Number of Connections a pool will try to acquire upon startup. Should be between minPoolSize and maxPoolSize.",
				0, -1));
		map.put("privilegeSpawnedThreads", MTGProperty.newBooleanProperty(FALSE,
		...
		map.put("debugUnreturnedConnectionStackTraces", MTGProperty.newBooleanProperty(FALSE,
		...
		map.put("breakAfterAcquireFailure", MTGProperty.newBooleanProperty(FALSE,
		...
		map.put("forceSynchronousCheckins", MTGProperty.newBooleanProperty(FALSE,
		...
		map.put("testConnectionOnCheckout", MTGProperty.newBooleanProperty(FALSE,
		...
		map.put("testConnectionOnCheckin", MTGProperty.newBooleanProperty(FALSE,
		...
		map.put("forceUseNamedDriverClass", MTGProperty.newBooleanProperty(FALSE,
		...
		map.put("maxStatements", MTGProperty.newIntegerProperty("0",
				...
				0, -1));
		map.put("maxIdleTime", MTGProperty.newIntegerProperty("60",
				"Seconds a Connection can remain pooled but unused before being discarded. Zero means idle connections never expire. ",
				0, -1));
		map.put("minPoolSize", MTGProperty.newIntegerProperty("3",
				"Minimum number of Connections a pool will maintain at any given time.", 1, -1));
		map.put("maxPoolSize", MTGProperty.newIntegerProperty("15",
				"Maximum number of Connections a pool will maintain at any given time.", 1, -1));
		map.put("maxStatementsPerConnection", MTGProperty.newIntegerProperty("0",
				...
				0, -1));
		map.put("maxIdleTimeExcessConnections", MTGProperty.newIntegerProperty("0",
				...
				0, -1));
		map.put("preferredTestQuery", new MTGProperty("",
				"Defines the query that will be executed for all connection tests.His is rarely useful, and should be left as null except when using very old (pre Java 6) or broken JDBC drivers."));
		map.put("acquireRetryDelay", MTGProperty.newIntegerProperty("1000",
				"Milliseconds, time c3p0 will wait between acquire attempts. ", 1000, -1));
		map.put("checkoutTimeout", MTGProperty.newIntegerProperty("0",
				"The number of milliseconds a client calling getConnection() will wait for a Connection to be checked-in or acquired when the pool is exhausted. Zero means wait indefinitely. Setting any positive value will cause the getConnection() call to time-out and break with an SQLException after the specified number of milliseconds",
				0, -1));
		map.put("unreturnedConnectionTimeout", MTGProperty.newIntegerProperty("0",
				...
				0, -1));
		map.put("acquireRetryAttempts", MTGProperty.newIntegerProperty("30",
				"Defines how many times c3p0 will retry after a failure to acquire a new Connection from the database before giving up. If this value is less than zero, c3p0 will keep trying to fetch a Connection indefinitely.",
				0, -1));
		map.put("maxAdministrativeTaskTime", MTGProperty.newIntegerProperty("0",
				"Seconds before c3p0's thread pool will try to interrupt an apparently hung task. Rarely useful. ", 0,
				-1));
		map.put("statementCacheNumDeferredCloseThreads", MTGProperty.newIntegerProperty("0",
