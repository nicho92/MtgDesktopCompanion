...
public class DBCPPool extends AbstractPoolProvider {
	...
	public Map<String, MTGProperty> getDefaultAttributes() {
		...
		map.put("defaultAutoCommit", MTGProperty.newBooleanProperty(TRUE,
		...
		map.put("cacheState", MTGProperty.newBooleanProperty(TRUE,
		...
		map.put("testWhileIdle", MTGProperty.newBooleanProperty(FALSE,
		...
		map.put("poolPreparedStatements",
				MTGProperty.newBooleanProperty(FALSE, "Enable prepared statement pooling for this pool"));
		map.put("logExpiredConnections", MTGProperty.newBooleanProperty(TRUE,
		...
		map.put("enableAutoCommitOnReturn", MTGProperty.newBooleanProperty(TRUE,
		...
		map.put("rollbackOnReturn", MTGProperty.newBooleanProperty(TRUE,
		...
		map.put("defaultReadOnly", MTGProperty.newBooleanProperty(FALSE,
		...
		map.put("testOnCreate", MTGProperty.newBooleanProperty(FALSE,
		...
		map.put("testOnBorrow", MTGProperty.newBooleanProperty(TRUE,
		...
		map.put("testOnReturn", MTGProperty.newBooleanProperty(FALSE,
				"The indication of whether objects will be validated before being returned to the pool."));
		map.put("fastFailValidation", MTGProperty.newBooleanProperty(FALSE,
		...
		map.put("lifo", MTGProperty.newBooleanProperty(String.valueOf(BaseObjectPoolConfig.DEFAULT_LIFO),
		...
		map.put("maxTotal", MTGProperty.newIntegerProperty(String.valueOf(GenericObjectPoolConfig.DEFAULT_MAX_TOTAL),
				"The maximum number of active connections that can be allocated from this pool at the same time, or negative for no limit.",
				-1, -1));
		map.put("maxIdle", MTGProperty.newIntegerProperty(String.valueOf(GenericObjectPoolConfig.DEFAULT_MAX_IDLE),
				"The maximum number of connections that can remain idle in the pool, without extra ones being released, or negative for no limit.",
				-1, -1));
		map.put("minIdle", MTGProperty.newIntegerProperty(String.valueOf(GenericObjectPoolConfig.DEFAULT_MIN_IDLE),
				"The minimum number of connections that can remain idle in the pool, without extra ones being created, or zero to create none.",
				-1, -1));
		map.put("validationQuery", new MTGProperty("",
		...
		map.put("initialSize", MTGProperty.newIntegerProperty("3",
				"The initial number of connections that are created when the pool is started.", 1, -1));
		map.put("maxConnLifetimeMILLIS", MTGProperty.newIntegerProperty("-1",
				...
				0, -1));
		map.put("maxWaitMILLIS", MTGProperty.newIntegerProperty(String.valueOf(BaseObjectPoolConfig.DEFAULT_MAX_WAIT),
				"The maximum number of milliseconds that the pool will wait (when there are no available connections) for a connection to be returned before throwing an exception, or -1 to wait indefinitely.",
				-1, -1));
		map.put("maxOpenPreparedStatements", MTGProperty.newIntegerProperty(
				String.valueOf(GenericKeyedObjectPoolConfig.DEFAULT_MAX_TOTAL),
				...
				1, -1));
		map.put("timeBetweenEvictionRunsMILLIS", MTGProperty.newIntegerProperty(
				String.valueOf(BaseObjectPoolConfig.DEFAULT_DURATION_BETWEEN_EVICTION_RUNS.toMillis()),
				"The number of milliseconds to sleep between runs of the idle object evictor thread. When non-positive, no idle object evictor thread will be run.",
				1, -1));
		map.put("numTestsPerEvictionRun",
				MTGProperty.newIntegerProperty(String.valueOf(BaseObjectPoolConfig.DEFAULT_NUM_TESTS_PER_EVICTION_RUN),
						"The number of objects to examine during each run of the idle object evictor thread (if any).",
						1, -1));
		map.put("minEvictableIdleTimeMILLIS", MTGProperty.newIntegerProperty(
				String.valueOf(BaseObjectPoolConfig.DEFAULT_MIN_EVICTABLE_IDLE_DURATION.toMillis()),
				"The minimum amount of time in milisecond an object may sit idle in the pool before it is eligible for eviction by the idle object evictor (if any).",
				1000, -1));
		map.put("softMinEvictableIdleTimeMILLIS", MTGProperty.newIntegerProperty(
				String.valueOf(BaseObjectPoolConfig.DEFAULT_SOFT_MIN_EVICTABLE_IDLE_DURATION.toMillis()),
				...
				-1, -1));
		map.put("accessToUnderlyingConnectionAllowed", MTGProperty.newBooleanProperty(FALSE,
				"Controls if the PoolGuard allows access to the underlying connection."));
		map.put("jmxName", new MTGProperty("org.magic.api:type=Pool,name=" + getName(),
				"Registers the DataSource as JMX MBean under specified name. The name has to conform to the JMX Object Name Syntax (see javadoc)."));
	...
	public String getVersion() {
		return POMReader.readVersionFromPom(C3P0Config.class,
