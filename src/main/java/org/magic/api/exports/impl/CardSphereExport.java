...
public class CardSphereExport extends AbstractFormattedFileCardExport {
	...
	public void exportStock(List<MTGCardStock> stock, File f) throws IOException {
		...
		stock.forEach(mcs -> {
			buff.append("\"").append(mcs.getQte()).append("\"").append(getSeparator()).append("\"").append(mcs.getQte())
					.append("\"").append(getSeparator()).append("\"").append(mcs.getProduct().getName()).append("\"")
					.append(getSeparator()).append("\"").append(mcs.getProduct().getEdition().getSet()).append("\"")
					.append(getSeparator()).append("\"").append(aliases.getConditionFor(this, mcs.getCondition()))
					.append("\"").append(getSeparator()).append("\"").append(mcs.getLanguage()).append("\"")
					.append(getSeparator()).append("\"").append(mcs.isFoil() ? "Foil" : "").append("\"")
					.append(getSeparator()).append("\"").append("").append("\"").append(System.lineSeparator());
