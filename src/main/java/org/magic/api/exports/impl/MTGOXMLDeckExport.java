...
public class MTGOXMLDeckExport extends AbstractCardExport {
	...
	public void exportDeck(MTGDeck deck, File dest) throws IOException {
		...
		temp.append("<?xml version=\"1.0\" encoding=\"UTF-8\"?>").append(System.lineSeparator()).append(
				"<Deck xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">")
				.append(System.lineSeparator()).append("<NetDeckID>0</NetDeckID>").append(System.lineSeparator())
				.append("<PreconstructedDeckID>0</PreconstructedDeckID>").append(System.lineSeparator());

		deck.getMain().entrySet()
				.forEach(e -> temp.append("<Cards CatID=\"1\" Quantity=\"").append(e.getValue())
						.append("\" Sideboard=\"false\" Name=\"").append(e.getKey().getName())
						.append("\" Annotation=\"0\"/>").append(System.lineSeparator()));

		deck.getSideBoard().entrySet()
				.forEach(e -> temp.append("<Cards CatID=\"1\" Quantity=\"").append(e.getValue())
						.append(" Sideboard=\"true\" Name=\"").append(e.getKey().getName())
						.append("\" Annotation=\"0\"/>").append(System.lineSeparator()));
		temp.append("</Deck>");
	...
	private void read(Node obj, MTGDeck deck) throws DOMException, IOException {
		try {
			...
			var mc = MTG.getEnabledPlugin(MTGCardsProvider.class)
					.searchCardByName(obj.getAttributes().getNamedItem("Name").getTextContent(), null, true).get(0);
