...
public class LookAndFeelProvider {
	...
	public void setLookAndFeel(Component ui, String lookAndFeel, boolean saving) {
		try {
			...
			logger.debug("loading look&feel custom file : {} : {}",
					new File(MTGConstants.DATA_DIR, "FlatLaf.properties").getAbsolutePath(),
					new File(MTGConstants.DATA_DIR, "FlatLaf.properties").exists());
