...
public class CardStockPanel extends JPanel {
	...
	public CardStockPanel() {
		...
		btnAdd.setIcon(new ImageIcon(CardStockPanel.class.getResource("/res/new.png")));
	...
	public void initMagicCardStock(MagicCard mc,MagicCollection col)
	{
		...
		content.setLayout(layout);
		try {
				for(MagicCardStock stat : MagicFactory.getInstance().getEnabledDAO().getStocks(mc,col))
				{
