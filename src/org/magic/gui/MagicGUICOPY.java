...
public class MagicGUICOPY extends JFrame {

	static final Logger logger = LogManager.getLogger(MagicGUICOPY.class.getName());

	private static final int INDEX_PRICES = 2;

	TrayIcon trayIcon = new TrayIcon(Toolkit.getDefaultToolkit().getImage(MagicGUICOPY.class.getResource("/res/logo.gif")).getScaledInstance(16, 16, BufferedImage.SCALE_SMOOTH));
	...
	public void initGUI() throws Exception
	{
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(MagicGUICOPY.class.getResource("/res/logo.gif")));
		setJMenuBar(menuBar);
	...
	//	looks.add(new SyntheticaPlainLookAndFeel().getClass().getName());
		...
		btnSearch = new JButton(new ImageIcon(MagicGUICOPY.class.getResource("/res/search.png")));
		btnExport = new JButton(new ImageIcon(MagicGUICOPY.class.getResource("/res/export.png")));
		...
		lblLoading.setIcon(new ImageIcon(MagicGUICOPY.class.getResource("/res/load.gif")));
		...
		tabbedCardsView.addTab("Results", null, panelResultsCards, null);
				...
				scrollCards.setMinimumSize(new Dimension(0, 0));
						...
						btnClear.setIcon(new ImageIcon(MagicGUICOPY.class.getResource("/res/09_clear_location.png")));
		...
		tabbedPane.addTab("Search", new ImageIcon(MagicGUICOPY.class.getResource("/res/search.gif")), globalPanel, null);
		tabbedPane.addTab("Deck", new ImageIcon(MagicGUICOPY.class.getResource("/res/book_icon.jpg")), new DeckBuilderGUI(), null);
		tabbedPane.addTab("Game", new ImageIcon(MagicGUICOPY.class.getResource("/res/bottom.png")), GamePanelGUI.getInstance(), null);
		tabbedPane.addTab("Collection", new ImageIcon(MagicGUICOPY.class.getResource("/res/collection.png")), new CollectionPanelGUI(), null);
		tabbedPane.addTab("DashBoard", new ImageIcon(MagicGUICOPY.class.getResource("/res/dashboard.png")), new DashBoardGUI(), null);
		tabbedPane.addTab("Shopping", new ImageIcon(MagicGUICOPY.class.getResource("/res/shop.gif")), new ShopperGUI(), null);
		tabbedPane.addTab("Alert", new ImageIcon(MagicGUICOPY.class.getResource("/res/bell.png")), new AlarmGUI(), null);
		tabbedPane.addTab("Builder", new ImageIcon(MagicGUICOPY.class.getResource("/res/create.png")), new CardBuilderPanelGUI(), null);
		tabbedPane.addTab("RSS", new ImageIcon(MagicGUICOPY.class.getResource("/res/rss.png")), new RssGUI(), null);
		tabbedPane.addTab("Configuration", new ImageIcon(MagicGUICOPY.class.getResource("/res/build.png")), new ConfigurationPanelGUI(), null);
